...
// cd BaseDatos && g++ -c GestorBaseDatos.cpp -o GestorBaseDatos.o && cd .. && cd Logger && g++ -c Logger.cpp -o Logger.o && cd .. && cd Socket && g++ -c serverSocket.cpp -o serverSocket.o && cd .. && cd Main && g++ -c main.cpp -o main.o
